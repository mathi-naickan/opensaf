...
FUNC_DECLARATION(DS)
{
	...
	NCS_ENC_DEC_ARRAY(DS) {
		...
		{
		EDU_START, FUNC_NAME(CPSV_ND2D_CKPT_INFO_UPD), 0, 0, 0, sizeof(DS), 0, NULL}, {
		EDU_EXEC, ncs_edp_uns64, 0, 0, 0, (long)&((DS *) 0)->ckpt_id, 0, NULL}, {
		EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, (long)&((DS *) 0)->ckpt_name, 0, NULL}, {
		EDU_EXEC, FUNC_NAME(SaCkptCheckpointCreationAttributesT), 0, 0, 0,
			    (long)&((DS *) 0)->attributes, 0, NULL}, {
		...
		EDU_VER_GE, NULL, 0, 0, 2, 0, 0, (EDU_EXEC_RTINE)((uint16_t *)(&(ver_compare)))}, {
		EDU_EXEC, FUNC_NAME(SaVersionT), 0, 0, 0, (long)&((DS *) 0)->client_version, 0, NULL}, {
		EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, (long)&((DS *) 0)->is_active, 0, NULL}, {
		...
		EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, (long)&((DS *) 0)->is_last, 0, NULL}, {
		EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, (long)&((DS *) 0)->is_unlink, 0, NULL}, {
	EDU_END, 0, 0, 0, 0, 0, 0, NULL},};
	NCS_ENC_DEC_REM_FLOW(DS)
}
#undef DS
...
FUNC_DECLARATION(DS)
{
	...
	NCS_ENC_DEC_ARRAY(DS) {
		...
		{
			EDU_START, FUNC_NAME(CPSV_A2ND_ARRIVAL_UNREG), 0, 0, 0, sizeof(DS), 0, NULL}, {
				EDU_EXEC, ncs_edp_uns64, 0, 0, 0, (long)&((DS *) 0)->client_hdl, 0, NULL}, {
					EDU_END, 0, 0, 0, 0, 0, 0, NULL},};
			NCS_ENC_DEC_REM_FLOW(DS)
}
...
FUNC_DECLARATION(DS)
{
	...
	NCS_ENC_DEC_ARRAY(DS) {
		...
		EDU_EXEC, FUNC_NAME(CPSV_A2ND_CKPT_LIST_UPDATE), 0, 0, EDU_EXIT, (long)&((DS *) 0)->info.ckptListUpdate, 0, NULL},{
			EDU_EXEC, FUNC_NAME(CPSV_A2ND_ARRIVAL_UNREG), 0, 0, EDU_EXIT, (long)&((DS *) 0)->info.arr_ntfy, 0, NULL},{
		EDU_EXEC, FUNC_NAME(CPSV_SAERR_INFO), 0, 0, EDU_EXIT, (long)&((DS *) 0)->info.ckpt_info_update_ack, 0, NULL}, {
	EDU_END, 0, 0, 0, 0, 0, 0, NULL},};
	NCS_ENC_DEC_REM_FLOW(DS)
}
...
FUNC_DECLARATION(DS)
{
	...
	NCS_ENC_DEC_ARRAY(DS) {
		...
		EDU_EXEC, FUNC_NAME(CPSV_ND2D_CKPT_INFO_UPD), 0, 0, EDU_EXIT, (long)&((DS *) 0)->info.ckpt_info,
			    0, NULL}, {
	EDU_END, 0, 0, 0, 0, 0, 0, NULL},};
	NCS_ENC_DEC_REM_FLOW(DS)
}
